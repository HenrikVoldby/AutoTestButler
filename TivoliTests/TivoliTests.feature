...
@InternetExplorer
Scenario: I can access the contact us page in IE
...
Scenario: I can not enter an invalid email address when applying for news letter in Chrome
	...
	Given I click the main menu item with text 'Mad og drikke'
	 ...
	 Then The 'NewsletterFormEmailID' textbox shows validation message 'Please include an '@' in the email address.'
...
@PhantomJS
Scenario: I can access the price information page in headless browser
	Given I open the Tivoli web site
	 Then The page contains header 'Glæd dig til'
